package com.telloquent.letsservicetask.custom;
...
public class ATProgressDialog extends Dialog {
    ...
    LinearLayout progressBarParentLayout;
    public ATProgressDialog(Context context, boolean modal) {
        ...
        progressBarParentLayout=(LinearLayout) findViewById(R.id.progressBar_parent_layout);
